...
import { AnimatedGroup, AnimatedText, Button, HeroHeader } from "@/components/base/smoothui/shared";
        ...
        >
          <div className="mx-auto grid max-w-5xl items-center gap-10 px-6 py-24 lg:grid-cols-2 lg:gap-20">
            ...
            >
              ...
              >
                {buttons.primary ? (
                  <Button className="w-full sm:w-auto" variant="candy" render={<a href={buttons.primary.url} />} nativeButton={false}>{buttons.primary.text}</Button>
                ) : null}
                {buttons.secondary ? (
                  <Button variant="outline" render={<a href={buttons.secondary.url} />} nativeButton={false}>{buttons.secondary.text}<ArrowDownRight className="size-4" /></Button>
                ) : null}
              </AnimatedGroup>
            </AnimatedGroup>
