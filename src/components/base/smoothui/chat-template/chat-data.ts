// @ts-nocheck
import type { AIApprovalOption } from "@/components/base/smoothui/ai-approval";
import type { AIDiffLine } from "@/components/base/smoothui/ai-diff";
import type { AIPromptAttachment } from "@/components/base/smoothui/ai-prompt-input";
import type { AIResponseCitation } from "@/components/base/smoothui/ai-response";
import type { AISource } from "@/components/base/smoothui/ai-sources";
import type { AISuggestion } from "@/components/base/smoothui/ai-suggestions";
import type { AITask } from "@/components/base/smoothui/ai-task-list";
