...
import AIApproval from "@/components/base/smoothui/ai-approval";
import AIArtifact from "@/components/base/smoothui/ai-artifact";
import AIContextMeter from "@/components/base/smoothui/ai-context-meter";
import AIConversation from "@/components/base/smoothui/ai-conversation";
import type { AIState } from "@/components/base/smoothui/ai-core";
import AIDiff from "@/components/base/smoothui/ai-diff";
import AILoader from "@/components/base/smoothui/ai-loader";
import AIMessage from "@/components/base/smoothui/ai-message";
import AIPromptInput, {
  type AIPromptAttachment,
} from "@/components/base/smoothui/ai-prompt-input";
import AIReasoning from "@/components/base/smoothui/ai-reasoning";
import AIResponse from "@/components/base/smoothui/ai-response";
import AISources from "@/components/base/smoothui/ai-sources";
import AISuggestions from "@/components/base/smoothui/ai-suggestions";
import AITaskList from "@/components/base/smoothui/ai-task-list";
import AIToolCall from "@/components/base/smoothui/ai-tool-call";
import SiriOrb from "@/components/base/smoothui/siri-orb";
