...
import { DURATION_INSTANT, SPRING_DEFAULT } from "@/components/base/smoothui/lib/animation";
...
export default function Combobox({
  ...
  return (
    <Popover onOpenChange={setOpen} open={open}>
      <PopoverTrigger render={<SmoothButton aria-expanded={open} aria-haspopup="listbox" aria-label={ariaLabel} aria-labelledby={ariaLabelledBy} className={cn(
                      ...
                      className
                    )} disabled={disabled} role="combobox" type="button" variant="outline" />}><span
                      className={cn(
                    ...
                    </span><ChevronsUpDownIcon className="ml-2 size-4 shrink-0 opacity-50 transition-colors" /></PopoverTrigger>
      <PopoverContent
        align="start"
        className={cn(
