            ...
            <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
              <AnimatedGroup className="space-y-8" preset="blur-slide">
                ...
                >
                  ...
                  >
                    <Button size="lg" variant="candy" render={<a href={primaryButton.url} />} nativeButton={false}><span className="text-nowrap">
                                                                {primaryButton.text}
                                                              </span></Button>
                  </motion.div>
                  ...
                  <motion.div
                    ...
                    whileTap={shouldReduceMotion ? {} : { scale: 0.95 }}
                  >
                    <Button size="lg" variant="outline" render={<a href={secondaryButton.url} />} nativeButton={false}><span className="text-nowrap">
