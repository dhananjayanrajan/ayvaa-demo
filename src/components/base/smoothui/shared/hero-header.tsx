...
import SmoothButton from "@/components/base/smoothui/smooth-button";
              ...
              <div className="flex w-full justify-between gap-6 lg:w-auto">
                ...
                <div className="m-auto hidden size-fit lg:block">
                  <ul className="flex gap-1">
                    {menuItems.map((item) => (
                      <li key={item.id}>
                        <SmoothButton size="sm" variant="ghost" render={<a className="text-base" href={item.href} />}><span>{item.name}</span></SmoothButton>
                      </li>
                    ))}
                  </ul>
                </div>
