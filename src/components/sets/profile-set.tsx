...
import { Award, BadgeCheck, CalendarDays, Check, Eye, FileCheck2, FileImage, FileText, HeartPulse, Landmark, Loader2, Lock, Pencil, Plus, Quote, Send, ShieldCheck, Star, Stethoscope, Upload } from 'lucide-react'
import { Row } from '@/components/base/phone/row'
import { motion } from 'motion/react'
import type { TileTone } from '@/components/base/phone/kit'
import { Card, Chip, Kicker, Ring } from '@/components/base/phone/kit'
...
export function ProfileHero_Patient({ name, role, years, rating, visits, onTime, offer }: ProfileHeroProps) {
...
export function ProfileHero_Professional({ name, role, initials, rating, visits, years, openDays }: Props_ProfileHero) {
  return (
