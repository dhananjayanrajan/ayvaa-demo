...
import { HeroHighlight, HeroTopRow, StatCell, TapCell } from '@/components/base/phone/hero-cells'
import { LifecycleButton } from '@/components/base/phone/lifecycle-button'
import { OptionCheck, OptionRow } from '@/components/base/phone/option-row'
