            ...
            <div className="shrink-0 px-5 pb-3 pt-3">
              <div className="flex items-start gap-3">
                <span className="grid h-11 w-11 shrink-0 place-items-center rounded-2xl bg-emerald-500/10 text-emerald-700">
                  <FileText className="h-5 w-5" strokeWidth={2.2} aria-hidden />
                </span>
                <div className="min-w-0 flex-1">
                  <div className="break-words text-[15px] font-extrabold leading-snug tracking-tight text-[#0B211B]">
                    {consentReview.name}
                  </div>
                  <div className="mt-0.5 break-words text-[12px] font-medium text-[#0B211B]/55">{consentReview.category}</div>
                </div>
                <motion.button
                  type="button"
                  whileTap={{ scale: 0.92 }}
