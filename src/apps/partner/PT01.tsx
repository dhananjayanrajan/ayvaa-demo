...
import { Chip, Hero, Kicker, LiveDot, rise, stagger } from '@/components/base/phone/kit'
import { PartnerCredentialCard } from '@/components/patterns/cards/partner-credential-card'
