...
import { ApplicationHero } from '@/components/admin/heroes/ApplicationHero'
import { DocumentList } from '@/components/admin/lists/DocumentList'
import { VerificationList } from '@/components/admin/lists/VerificationList'
import { ApplicationDecision } from '@/components/admin/actions/ApplicationDecision'
