...
import { BodyArea, FootBar, Screen } from '@/components/base/phone/screen'
import { Tile, rise, stagger } from '@/components/base/phone/kit'
import { NoteStrip } from '@/components/base/phone/note-strip'
import { CtaNote } from '@/components/base/phone/lifecycle-button'
import { lovedOnes } from '@/data/seed'
import { medVerification, quickTags, sessionNote } from '@/data/professionalCare'
import { useDemo } from '@/lib/store'
import { useRouter } from '@/lib/router'
import { EntrySheetsHero } from '@/components/sets/sheets-set'
import { SegmentedTabs } from '@/components/base/phone/segmented-tabs'
import { VitalsPanel } from '@/components/sets/sheets-set'
import { MedVerificationPanel } from '@/components/sets/sheets-set'
import { NotesPanel } from '@/components/sets/sheets-set'
import { SaveSheetButton, type SaveStatus } from '@/components/sets/sheets-set'
import { ReopenSheetsBar } from '@/components/sets/sheets-set'
import {
  MODE_META,
  SAVE_LABELS,
  SHEET_MODES,
