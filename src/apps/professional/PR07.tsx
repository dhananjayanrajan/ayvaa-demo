...
import { EntrySheetsHero } from '@/components/sheets/SheetsSet'
import { SegmentedTabs } from '@/components/phone/SegmentedTabs'
import { VitalsPanel } from '@/components/sheets/SheetsSet'
import { MedVerificationPanel } from '@/components/sheets/SheetsSet'
import { NotesPanel } from '@/components/sheets/SheetsSet'
import { SaveSheetButton, type SaveStatus } from '@/components/sheets/SheetsSet'
import { ReopenSheetsBar } from '@/components/sheets/SheetsSet'
import {
  MODE_META,
  SAVE_LABELS,
  SHEET_MODES,
