...
import { OnboardingHero } from '@/components/sets/onboarding-set'
import { SafetyChecksCard } from '@/components/sets/onboarding-set'
import { TermsAcceptanceCard } from '@/components/sets/onboarding-set'
import { OnboardingFooter } from '@/components/sets/onboarding-set'
