...
import { BodyArea, Screen } from '@/components/base/phone/screen'
import { Tile, rise, stagger } from '@/components/base/phone/kit'
import { lovedOnes } from '@/data/seed'
import { incidentCauses } from '@/data/professionalCare'
import { useDemo } from '@/lib/store'
import { useRouter } from '@/lib/router'
import { cn } from '@/lib/utils'
import { IncidentHero } from '@/components/sets/incidents-set'
import { SeveritySelector } from '@/components/sets/incidents-set'
import { TriggerPreview } from '@/components/sets/incidents-set'
import { CausePicker } from '@/components/sets/incidents-set'
import { DescriptionInput } from '@/components/sets/incidents-set'
import { PhotoAttach } from '@/components/sets/incidents-set'
import { ActionButton } from '@/components/base/phone/action-pair'
import { SubmittedPanel } from '@/components/sets/incidents-set'
