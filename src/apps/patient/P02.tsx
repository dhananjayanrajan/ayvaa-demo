...
import { DigestHero } from '@/components/patterns/heroes/digest-hero'
import { BiometricUnlock } from '@/components/patterns/actions/biometric-unlock'
import type { ScanState } from '@/components/patterns/actions/biometric-unlock'
import { PasswordCard_Patient as PasswordCard } from '@/components/patterns/cards/patient-password-card'
import type { SignInState } from '@/components/patterns/cards/patient-password-card'
import { CreateAccountCard } from '@/components/patterns/cards/create-account-card'
import { DigestDetail } from '@/components/patterns/cards/digest-detail'
import { MarkSeenButton } from '@/components/patterns/actions/mark-seen-button'
import type { SeenState } from '@/components/patterns/actions/mark-seen-button'
import { ResetInfo } from '@/components/patterns/cards/reset-info'
import { SendResetButton } from '@/components/patterns/actions/send-reset-button'
import type { SendState } from '@/components/patterns/actions/send-reset-button'
