...
import { VisitsHero } from '@/components/patterns/heroes/visits-hero'
import { SegmentedTabs } from '@/components/base/phone/segmented-tabs'

type VisitTab = 'upcoming' | 'completed' | 'missed'
import { LiveVisitCard } from '@/components/patterns/cards/live-visit-card'
import { UpcomingCard } from '@/components/patterns/cards/upcoming-card'
import { CompletedCard } from '@/components/patterns/cards/completed-card'
import { MissedCard } from '@/components/patterns/cards/missed-card'
import { EmptyTabState } from '@/components/patterns/cards/empty-tab-state'
import { FilterSheet } from '@/components/patterns/sheets/filter-sheet'
import {
  activeFilterCount,
  applyVisitFilters,
  completedVisits,
