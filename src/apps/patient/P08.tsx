...
import { CatalogueHero } from '@/components/catalogue/CatalogueSet'
import { CategoryRail } from '@/components/catalogue/CatalogueSet'
import { ServiceList } from '@/components/catalogue/CatalogueSet'
import type { ListedService } from '@/components/catalogue/CatalogueSet'
import { MatchCard } from '@/components/catalogue/CatalogueSet'
import type { LifecyclePhase } from '@/components/phone/LifecycleButton'
import { FiltersSheet } from '@/components/catalogue/CatalogueSet'
import type { ApplyState } from '@/components/catalogue/CatalogueSet'
import { ServiceSheet } from '@/components/catalogue/CatalogueSet'
import type { BookingState } from '@/components/catalogue/CatalogueSet'
import {
  BUDGET_LIMIT,
  buildCategoryChips,
  iconFor,
