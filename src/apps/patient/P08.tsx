...
import { CatalogueHero } from '@/components/patterns/heroes/catalogue-hero'
import { CategoryRail } from '@/components/patterns/navigation/category-rail'
import { ServiceList } from '@/components/patterns/lists/service-list'
import type { ListedService } from '@/components/patterns/lists/service-list'
import { MatchCard } from '@/components/patterns/cards/catalogue-match-card'
import type { LifecyclePhase } from '@/components/base/phone/lifecycle-button'
import { FiltersSheet } from '@/components/patterns/sheets/filters-sheet'
import type { ApplyState } from '@/components/patterns/sheets/filters-sheet'
import { ServiceSheet } from '@/components/patterns/sheets/service-sheet'
import type { BookingState } from '@/components/patterns/sheets/service-sheet'
import {
  BUDGET_LIMIT,
  buildCategoryChips,
  iconFor,
