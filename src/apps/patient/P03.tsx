...
import { Chip, Panel, Tile, rise, stagger } from '@/components/base/phone/kit'
import { StatusStrip } from '@/components/base/phone/status-strip'
import { JourneyRail } from '@/components/patterns/navigation/journey-rail'
import { OtpInput } from '@/components/patterns/forms/otp-input'
import { ResendRow } from '@/components/base/phone/action-pair'
import { VerifyButton } from '@/components/patterns/actions/verify-button'
import type { VerifyState } from '@/components/patterns/actions/verify-button'
import { NextStepsCard } from '@/components/patterns/cards/next-steps-card'
import { EmailFallbackSheet } from '@/components/patterns/sheets/email-fallback-sheet'
import type { EmailSendState } from '@/components/patterns/sheets/email-fallback-sheet'
