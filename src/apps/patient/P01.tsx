...
import { StaticButton, LifecycleButton, type LifecyclePhase } from '@/components/base/phone/lifecycle-button'
...
import { Hero } from '@/components/patterns/heroes/patient-onboarding-hero'
