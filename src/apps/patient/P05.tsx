...
import { RecoveryHero } from '@/components/patterns/heroes/recovery-hero'
import { SendLinkButton } from '@/components/patterns/actions/send-link-button'
import { SentCard } from '@/components/patterns/cards/sent-card'
import { GuaranteesCard } from '@/components/patterns/cards/guarantees-card'
import { SafetyCard } from '@/components/patterns/cards/safety-card'
import { RecoveryFoot } from '@/components/patterns/cards/recovery-foot'
import type { CallState } from '@/components/patterns/cards/sent-card'
